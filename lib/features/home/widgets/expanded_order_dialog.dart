...
/// Диалог с расширенной информацией о заказе для покупателя
class ExpandedOrderDialog extends StatefulWidget {
  final OrderModel order;
  final String nameRestaurant;
  final String address;
  final VoidCallback onReserve;

  const ExpandedOrderDialog({
    super.key,
    required this.order,
  ...
  @override
  State<ExpandedOrderDialog> createState() => _ExpandedOrderDialogState();
}

class _ExpandedOrderDialogState extends State<ExpandedOrderDialog> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTimeInfo(),
          const SizedBox(height: 5),
          Expanded(child: _buildDescriptionAndPrice()),
        ],
      ),
    );
  }
  ...
  Widget _buildDescriptionAndPrice() {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Expanded(
